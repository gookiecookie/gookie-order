...
function getComboMessage(count){
  ...
  if(count >= 4) return "🎉 Combo 4 applied. You saved RM5! Add 2 more Gookies to save RM8.";
...
function updateCart(){
  ...
  document.getElementById("cartTotal").innerText = money(data.total);updateComboMeter(data.count);
