...
const siteSearchIndex = [
...

  {
    ...
    subtitle: "Four crowd favourites in one box",
    href: "order.html#best-seller",
    keywords: "best seller assorted box 4",
  },
  {
    title: "The Whole Crew",
    subtitle: "All eight core Gookies",
    href: "order.html#whole-crew",
    keywords: "whole crew assorted box 8",
  },
  {
    title: "Build Your Own",
    subtitle: "Pick your favourites and build your box",
    href: "order.html#build-your-own",
    keywords: "build your own mix match",
  },
  {
    title: "Gookie Big Box",
    subtitle: "Box of 12 for sharing",
    href: "order.html",
    keywords: "big box 12 sharing gifting",
  },
  {
    title: "Mini Box",
  ...
  {
    title: "Party Kit",
    subtitle: "Make your box celebration-ready",
    href: "order.html#add-ons",
    keywords: "party kit candle cake board sprinkles add on",
  },
  {
    title: "Wish Card",
    subtitle: "Add a custom message",
    href: "order.html#add-ons",
    keywords: "wish card custom message add on",
  },
];
  ...
  if (!matches.length) {
    siteSearchResults.innerHTML = `
      <p class="search-empty">
        No Gookie found. Try another flavour or box name.
      </p>
    `;
    return;
  }
...
function setupSiteSearch() {
  searchButton?.addEventListener("click", openSiteSearch);
  searchModalClose?.addEventListener("click", closeSiteSearch);
